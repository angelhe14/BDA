...
declare
  v_count number;
  v_username varchar2(20) := 'ANGEL0104';
begin
...
Prompt creando al usuario angel0104
create user angel0104 identified by angel quota unlimited on users;
grant create session, create table to angel0104;

create table angel0104.t01_db_version as
